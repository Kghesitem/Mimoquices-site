...
<body>
    ...
    @if (Route::has('login'))
    @auth
        <a class="paginas" href="{{ url('/dashboard') }}">Dashboard</a>

        <div class="paginas dropdown">
            <a class=" dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="true">
                Olà, {{ Auth::user()->name }}
            </a>
            <ul class="dropdown-menu dropdown-menu-end">
                <li>
                    <form method="POST" action="{{ route('logout') }}" class="paginas a ">
                        @csrf
