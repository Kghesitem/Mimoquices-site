    ...
    <script>
        ...
        function verificaCategoria() {
            ...
            if (select.value === '1') {
                ...
                // Reset do formulário de personalização
                document.querySelector('input[name="pode_personalizar"][value="Não"]').checked = true;
                document.getElementById('opcoes-personalizacao').classList.remove('visible');
            }
        }
